import json
from src.modules.app.update_order.update_order_presenter import lambda_handler
from src.shared.domain.entities.pizza import Pizza


class Test_UpdateOrderPresenter:
    ...
    def test_update_order_non_valid_id_dash(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
