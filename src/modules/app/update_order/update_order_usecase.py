...
class UpdateOrderUsecase:
    ...
    def __call__(self, id: int, new_flavor: FLAVOR, new_stuffed_edge: STUFFED_EDGE) -> Order:
        ...
        return self.repo.update_order(id=id, new_flavor=new_flavor, new_stuffed_edge=new_stuffed_edge)